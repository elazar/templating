...
- [ ] Adapters
    ...
    - [x] [Mezzio Template Renderer](src/Adapter/Mezzio/MezzioRenderer.php) ([`schranz-templating/mezzio-template-adapter`](https://github.com/schranz-templating/mezzio-template-adapter))
